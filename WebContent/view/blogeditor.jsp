...
<body id="top">
   ...
   ================================================== -->
    ...
    <h3 align="center" style='height:50px;margin:0 auto'>你的文章的关键字</h3 >
    <input type="text" id="blogKeyword" name="blogKeyword" maxlength="4" class="keyword" style='margin:0 auto;background: #FFFFFF;height:45px;color: #000000'/>
	...
	<div style='height:40px;margin:0 auto'></div>
    <h3 align="center" style='height:50px;margin:0 auto'>你的封面图描述</h3>
    <input type="text" id="blogDescription" name="blogDescription" maxlength="100" class="description" style='margin:0 auto;width:500px;background: #FFFFFF;height:45px;color: #000000'/>
	...
	<script type="text/javascript" src="<%=basePath%>js/wangEditor/wangEditor.js"></script>
