...
<body id="top">
   ...
   ================================================== -->
	...
	<h2 align="center" style='height:50px;margin:0 auto'>上传你的封面图</h2>
    
    <div style='height:25px;margin:0 auto'></div>
    
    <div align="center"  style='margin:0 auto'>
	<form name="Form2" action="springUpload" method="post" Style='margin:0 auto'enctype="multipart/form-data" align="center">
	<style>#fil{background:#FFFFFF no-repeat;border:none;width:220px}</style>
	<style>#sub{ no-repeat;border:none;height:60px;}</style>
		<input type="file" name="file" id="fil">
		<input type="hidden" name=blogid value=${blog.getBlogId() } >
		<input type="hidden" name=blogdescription value=${blog.getBlogDescription() }>
