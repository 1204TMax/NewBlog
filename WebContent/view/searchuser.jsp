...
<body id="top">
   ...
   ================================================== -->
    ...
    <div style='height:10px;margin:0 auto'></div>
 	...
 	<form id="blogcontent"  action="<%=basePath%>searchuserbyname" method="post">
	
    <h3 align="center" style='height:50px;margin:0 auto'>你要搜索的用户的名字</h3 >
    <input type="text" id="username" name="username" class="username" style='margin:0 auto;background: #FFFFFF;height:45px;color: #000000'/>
    <div style='height:40px;margin:0 auto'></div>
